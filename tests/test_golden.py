...
def test_trace_contains_all_rules() -> None:
    ...
    expected = {
        ...
        "fed.2024.military.combat_pay_exclusion",
        "fed.2024.military.officer_cap",
        "fed.2024.military.officer_excess",
        "fed.2024.adjustments.military_moving",
        "fed.2024.adjustments.reservist_travel",
        "fed.2024.credits.eic.earned_income_elected",
        "fed.2024.credits.eic.phase_in_elected",
        "fed.2024.credits.eic.phase_out_elected",
        "fed.2024.credits.eic.tentative_elected",
        "fed.2024.deductions.additional_rate",
        "fed.2024.deductions.additional_standard",
        "fed.2024.deductions.standard_total",
        "fed.2024.credits.odc.base",
        "fed.2024.credits.ctc.combined",
        "fed.2024.credits.other_nonrefundable",
        "fed.2024.credits.ctc.tax_limit",
        "fed.2024.credits.actc.unused",
        "fed.2024.credits.actc.cap",
        "fed.2024.credits.actc.earned_income",
        "fed.2024.credits.actc.phase_in",
        "fed.2024.credits.actc.final",
        "fed.2024.addl_medicare.threshold",
        "fed.2024.addl_medicare.wage_excess",
        ...
        "fed.2024.income.short_term_net",
        "fed.2024.income.long_term_net",
        "fed.2024.carryover.used",
        "fed.2024.carryover.next_short",
        "fed.2024.carryover.next_total",
        "fed.2024.carryover.next_long",
...
def test_immutable_run_has_snapshot_and_metadata() -> None:
    ...
    assert run.rule_pack_version == "1.14.0"
